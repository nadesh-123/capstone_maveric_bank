...
public class BranchController {
    ...
    @PostMapping("/api/branch/create-branch")
    public BranchDto createBranch(@RequestBody BranchPostDto branchPostDto){
      return   branchService.createBranch(branchPostDto);
    }
