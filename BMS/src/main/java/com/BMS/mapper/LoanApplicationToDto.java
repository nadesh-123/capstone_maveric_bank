...
//    }
    ...
    public LoanApplicationDto mapLoanApplicationToDto(LoanApplication loanApplication){
        return  new LoanApplicationDto(loanApplication.getId(),loanApplication.getDisbursementAccount().getAccountNumber(),loanApplication.getLoneType(),loanApplication.getRequestedAmount(),loanApplication.getTenureYears(),loanApplication.getPurpose(),loanApplication.getMonthlyIncome(),loanApplication.getLoanStatus(),loanApplication.getApplication_date());
    }
}